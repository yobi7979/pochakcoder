...
:: GitHub 푸시 스크립트 (stage/main 저장소 선택)
echo [36mSportsCoder GitHub 푸시 스크립트[0m
echo.
...
if not exist .git (
    ...
    git init
    git remote add stage https://github.com/yobi7979/pochakcoder.git
    git remote add main https://github.com/yobi7979/sportscoder.git
) else (
...
:: 푸시 대상 저장소 선택
echo.
echo [33m=== 푸시 대상 저장소 선택 ===[0m
echo [36m1. stage (테스트용) - pochakcoder[0m
echo [36m2. main (실제 사용) - sportscoder[0m
echo.
set /p choice="저장소를 선택하세요 (1 또는 2): "

if "!choice!"=="1" (
    set remote_name=stage
    set remote_url=https://github.com/yobi7979/pochakcoder.git
    set repo_name=pochakcoder
    echo [33m테스트용 저장소(stage)를 선택했습니다.[0m
) else if "!choice!"=="2" (
    set remote_name=main
    set remote_url=https://github.com/yobi7979/sportscoder.git
    set repo_name=sportscoder
    echo [33m실제 사용 저장소(main)를 선택했습니다.[0m
) else (
    echo [31m잘못된 선택입니다. 1 또는 2를 입력해주세요.[0m
    pause
    exit /b
)
...
echo [36m선택된 원격 저장소: !remote_name![0m
echo [36m저장소 URL: !remote_url![0m
echo.
...
if !errorlevel! equ 0 (
    ...
    echo [32m저장소 URL: !remote_url![0m
    echo [32m푸시된 저장소: !remote_name! (!repo_name!)[0m
) else (
    echo.
