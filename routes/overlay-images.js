  ...
  try {
    ...
    try {
      ...
      if (existingTeam) {
        ...
        console.error(`❌ TeamInfo 레코드가 없음: matchId=${req.body.matchId}, teamType=${req.body.teamType}`);
        ...
        console.log(`⚠️ TeamInfo 임시 레코드 생성: ID ${newTeamInfo.id}, matchId=${req.body.matchId}, teamType=${req.body.teamType}`);
      }
